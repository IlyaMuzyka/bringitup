...
function () {
  ...
  _createClass(Difference, [{
    key: "bindTriggers",
    value: function bindTriggers(plus, items, counter) {
...
function () {
  ...
  _createClass(Download, [{
    key: "downloadClick",
    value: function downloadClick(path) {
    ...
    value: function init() {
      ...
      this.triggers.forEach(function (trigger) {
        trigger.addEventListener('click', function (e) {
          ...
          _this.downloadClick(_this.path);
        });
      });
    }
  }]);
...
function () {
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function onPlayerStateChange(state) {
      try {
        var playBtn = this.activeTrigger.querySelector('svg').cloneNode(true);
        var blockedElem = this.activeTrigger.closest('.module__video-item').nextElementSibling,
...
function () {
  ...
  _createClass(ShowInfo, [{
    ...
    value: function init() {
      this.triggers.forEach(function (trigger) {
        trigger.addEventListener('click', function () {
          var content = trigger.closest('.module__info-show').nextElementSibling;
